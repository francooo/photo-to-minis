    ...
    <section className="py-[100px] px-[5vw] relative bg-[hsl(var(--surface))] overflow-hidden" id="modalidades">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-[2px] mt-14" style={{ background: 'hsl(var(--border-custom))' }}>
        ...
        <div onClick={() => scrollTo("carros")} className="relative overflow-hidden cursor-pointer min-h-[480px] flex flex-col justify-end group" style={{ background: 'linear-gradient(135deg, #0a0f18, #111827)' }}>
          <div className="absolute inset-0 bg-gradient-to-t from-[rgba(8,10,14,0.95)] via-[rgba(8,10,14,0.4)] to-transparent transition-opacity group-hover:opacity-85" />
          ...
          <div className="absolute bottom-0 left-0 right-0 h-[3px] bg-gradient-to-r from-[hsl(var(--accent-orange))] to-transparent scale-x-0 origin-left transition-transform group-hover:scale-x-100" />
        </div>
        ...
        <div onClick={() => scrollTo("miniaturas")} className="relative overflow-hidden cursor-pointer min-h-[480px] flex flex-col justify-end group" style={{ background: 'linear-gradient(135deg, #0a0818, #141028)' }}>
          <div className="absolute inset-0 transition-opacity group-hover:opacity-85" style={{ background: 'linear-gradient(to top, rgba(8,10,14,0.97) 0%, rgba(20,10,40,0.35) 50%, transparent 75%)' }} />
          ...
          <div className="absolute bottom-0 left-0 right-0 h-[3px] bg-gradient-to-r from-[hsl(var(--violet))] to-transparent scale-x-0 origin-left transition-transform group-hover:scale-x-100" />
        </div>
      </div>
    </section>
  );
